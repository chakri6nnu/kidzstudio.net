  ...
  const features = [
    {
      ...
      description:
        "Comprehensive library of questions across multiple subjects and difficulty levels",
      color: "text-primary",
    ...
    },
    {
      ...
      description:
        "Efficiently manage students, teachers, and administrators with role-based access",
      color: "text-accent",
    ...
    },
    {
      ...
      description:
        "Detailed insights and performance analytics to track progress and identify improvements",
      color: "text-success",
    ...
    },
    {
      ...
      description:
        "Live exam monitoring with anti-cheating measures and instant notifications",
      color: "text-primary",
      bgColor: "bg-primary/10",
    },
    {
  ...
  const testimonials = [
    {
      ...
      image: "/admin.png",
      quote:
        "QwikTest has revolutionized how we conduct assessments. The platform is intuitive, reliable, and has significantly improved our exam efficiency.",
    },
    {
      name: "Michael Chen",
      ...
      image: "/teacher.png",
      quote:
        "The analytics and reporting features are outstanding. We can now track employee progress and identify training gaps more effectively.",
    },
    {
      name: "Lisa Rodriguez",
      ...
      image: "/student.png",
      quote:
        "As an educator, I love how easy it is to create engaging quizzes. My students enjoy the interactive experience and immediate feedback.",
    },
  ];
        ...
        <div className="container relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              ...
              From question banks to detailed analytics, everything you need in
              one place.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                asChild
                className="bg-gradient-primary hover:bg-primary-hover shadow-primary text-lg px-8"
              >
                <Link to="/auth/login">
        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Powerful features designed to streamline your examination process
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="bg-gradient-card hover:shadow-elegant transition-all duration-300 group"
              >
                <CardHeader>
                  <div
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8">
                ...
                assessment process with our platform.
              </p>
              ...
              <Button
                size="lg"
                className="mt-8 bg-gradient-primary hover:bg-primary-hover"
              >
                Learn More
      ...
      <section className="py-20 bg-gradient-subtle">
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Flexible pricing options to suit organizations of all sizes. Start
          ...
          <Card className="bg-gradient-primary text-primary-foreground">
            <CardContent className="py-16 text-center">
              ...
              <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
                Join thousands of educators who are already using QwikTest to
